        ...
        <div className="App">
          ...
          <Routes>
            ...
            <Route
              exact
              path="/park/:id1"
              element={<ParkForm></ParkForm>}
            ></Route>
            <Route
              exact
              path="/safari-form/:id1/:id2"
              element={<SafariForm></SafariForm>}
            ></Route>
            <Route
              exact
              path="/hotel-form/:id1/:id2"
              element={<HotelForm></HotelForm>}
            ></Route>
            <Route
              exact
              path="/activity-dash-form"
              element={<ActivityForm></ActivityForm>}
            ></Route>
            <Route
              exact
              path="/park-dash-form"
              element={<ParksDash></ParksDash>}
            ></Route>
            <Route
              exact
              path="/hotel-dash-form"
              element={<HotelDash></HotelDash>}
            ></Route>
            <Route exact path="/blogs" element={<Blogs></Blogs>}></Route>
            <Route
              exact
              path="/parks/:state_name"
              element={<States></States>}
            ></Route>
            <Route
              exact
              path="/parks/animals/:animal_name"
